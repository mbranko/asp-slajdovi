...
\begin{frame}[fragile]
  ...
  \end{itemize}
  $$ p(x,n) = \left\{ \begin{array}{l l} 1 & \quad \text{ako je} x=0 \\x\cdot p(x, \frac{n-1}{2})^2 & \quad \text{ako je} x>0 neparan\\p(x,n/2)^2 & \quad \text{ako je} x>0 paran \end{array}\right. $$
  \begin{itemize}
    \item na primer: \\
