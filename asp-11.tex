...
\begin{frame}[fragile]
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \item svaki list je \textbf{crn}
      \item deca \textbf{\myred{crvenog}} čvora su \textbf{crna}
      \item svi listovi imaju istu \textbf{crnu dubinu} $\Leftrightarrow$ sve putanje od korena do lista sadrže isti broj \textbf{crnih} čvorova
    \end{itemize}
  \end{itemize}
\end{frame}
