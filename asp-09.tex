...
\begin{frame}[fragile]
  ...
  \begin{itemize}
    ...
    $O(\log n)$ čvorova
    \begin{itemize}
      \item idi prema gore dok ne dođeš do korena ili levog deteta
      \item ako si došao do levog deteta, idi na desno dete
...
\begin{frame}[fragile]
  ...
  \begin{itemize}
    ...
    \item bottom-up konstrukcija je brža nego $n$ dodavanja
  \end{itemize}
  \begin{center}
